<?php namespace Robbo\ValidationRules;
...
class Rule implements IteratorAggregate, Countable {
	 ...
	 *
	 * @var Robbo\ValidationRules\Builder\Buildable
	 */
	protected $builder;
	...
	/**
	 * Parse params to allow for array or argument input and then build the rule with the builder.
	 *
	 * * @param  string $rule
	 * @param  mixed  $params
	 * @return mixed
